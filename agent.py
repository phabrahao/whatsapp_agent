...
if __name__ == "__main__":
    ...
    result1 = run_agent("Create a meeting called 'Team Standup' tomorrow at 9 AM for 1 hour")
    print("Calendar result:", result1)
    
    # Test with location
    result2 = run_agent("Schedule a 'Doctor Appointment' on 2024-08-15 at 14:30 at 123 Medical Center, Boston")
    print("Appointment result:", result2)
    
    # Multimodal example with invitation image
    multimodal_data = [
        {"type": "text", "content": "Please create a calendar event based on this invitation:"},
        {"type": "image", "caption": "Wedding invitation", "image": b"fake_image_bytes"},
    ]
    
    result3 = run_agent(multimodal_data)
    print("Multimodal result:", result3)